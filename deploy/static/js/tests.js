...
test('ExampleController is an Ember Controller', function () {
	ok(Ember.Controller.detect(App.ExampleController), "App.ExampleController is an Ember.Controller subclass");
});
*/
...
/*
module('ExampleButtonComponent');

test('ExampleButtonComponent is an Ember Component', function () {
	ok(Ember.Component.detect(App.ExampleButtonComponent), "App.ExampleButtonComponent is an Ember.Component subclass");
});
...
test('Changing isEnabled should show and hide the .is-enabled and .is-not-enabled elements', function () {
	var component = createComponent('example-button');
...
test('ExampleMixin is an Ember Mixin', function () {
	ok(Ember.Mixin.detect(App.ExampleMixin), "App.ExampleMixin is an Ember.Mixin subclass");
});

test('ExampleMixin should call methods properly', function () {
	var ObjectWithMixin = Ember.Object.extend(App.ExampleMixin, {});

	var item = ObjectWithMixin.create();

	item.set('example-property', true);

	equal(item.get('other-property'), 'My Computed Value', "Setting example-property to true should change the other-property");
});
*/
...
test('Example model is an Ember Model', function () {
	ok(Ember.Model.detect(App.Example), "App.Example is an Ember.Model subclass");
});

test('Example model sets the fullName from firstName and lastName', function () {
	var item = App.Example.create({
		firstName : "Jeff",
		lastName : "Lebowski"
	});

	equal(item.get('fullName'), 'Jeff Lebowski', "The fullName should be computed from the firstName and lastName");
});
*/
...
test('The example route is wrapped in a <div> with the class "example-element"', function () {
	visit('/example');
	andThen(function () {
		ok(find('div.example-element').length, "The example route has an .example-element");
	});
});

test('The header contains a <h2> with the text "This is the Example Page"', function () {
	visit('/example');
	andThen(function () {
		ok(find('div.example-element h2:contains("This is the Example Page")').length, "There should be an <h2> containing 'This is the Example Page'");
	});
});
*/
...
test('ExampleView is an Ember View', function () {
	ok(Ember.View.detect(App.ExampleView), "App.ExampleView is an Ember.View subclass");
});
*/
